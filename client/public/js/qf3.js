            ...
            function activateCalendar(e) {
                ...
                var modyinp = function() {
                    if (widgets.length == 2 && setinp.data('settings').math) {
                        ...
                        var days = Math.floor((Date.parse(dt1) - Date.parse(dt0)) / 86400000);
                ...
                widgets.each(function() {
                    ...
                    widget.DatePicker({
                        ...
                        onChange: function(formated, dates) {
                            qf_date.find('input').val(formated);
                            widget.stop().animate({
                                height: 0
                            }, 300);
                            state = false;
                    ...
                    widget.DatePickerSetDate(qf_date.find('input').val(), true);

                    $('.qf_date_a', qf_date).add(qf_date.find('input')).on('click', function() {
                        widget.stop().animate({
